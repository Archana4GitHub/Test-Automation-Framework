...
public class AddNewAddressPage extends BrowserUtility {
	private static final By COMAPANY_TEXTBOX_LOCATOR = By.id("company");
	...
	private static final By OTHER__INFORMATION_TEXTAREA_LOCATOR = By.id("other");
	...
	public String saveAddress(AddressPOJO addressPOJO) {
		enterText(COMAPANY_TEXTBOX_LOCATOR, addressPOJO.getCompany());
		...
		enterText(OTHER__INFORMATION_TEXTAREA_LOCATOR, addressPOJO.getOtherInformation());
