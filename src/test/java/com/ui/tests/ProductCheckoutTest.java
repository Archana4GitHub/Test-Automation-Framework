...
public class ProductCheckoutTest extends TestBase {
	...
	public void setup() {
		searchResultPage = homePage.goToLoginPage().doLoginWith("cimlamakke@tozya.com", "password")
	...
	public void checkoutTest() {
		String result = searchResultPage.clickOnTheProductAtIndex(1).changeSize(L).addProductToCart()
			.proceedToCheckout().goToConfirmAddressPage().goToShipmentPage().goToPaymentPage().getPaymentConfirmationMessage();
