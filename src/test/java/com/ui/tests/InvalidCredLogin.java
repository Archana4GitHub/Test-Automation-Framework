...
public class InvalidCredLogin extends TestBase {
	Logger logger = LoggerUtility.getLogger(this.getClass());
	private static final String INVALID_EMAIL_ADDRESS = "archie4test123@gmail.com";
	private static final String INVALID_PASSWORD = "PWD2012fortestpwd";
